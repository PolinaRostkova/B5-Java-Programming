...
public class CurrencyConverter {
    ...
    // method will accept a currency type(String) and currency amount
    ...
    public static void main(String[] args) {
        ...
        double dollarToLLira = convertCurrency("lira", 200);
        System.out.println("Dollar to Lira: " + dollarToLLira);

        double dollarToWon = convertCurrency("won", 1000);
        System.out.println(dollarToWon);
    }
}
