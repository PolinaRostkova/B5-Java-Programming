...
public class UsingCollectionsClass {
    public static void main(String[] args) {
        ...
        // Arrays.sort(); --> works only with Array
...
//        System.out.println( Collections.max(letters)); | normally not used with characters or string, only with numbers
//        System.out.println( Collections.max(letters));
        ...
        System.out.println("Before set: " + words);
        words.set(0, "mon");
        System.out.println("After set method: " + words);
